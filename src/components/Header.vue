...
<template>
    ...
    <nav class="header-nav" :style="{right: isOpen ? '0' : '-100%'}">
      <ul>
        ...
        <li class="logo-li"><img src="/img/flower.png"  alt="flower" width="48" height="48"/>
        <img src="/img/soju.png"  alt="soju" width="48" height="48"/>
        <img src="/img/south-korea.png"  alt="south-korea" width="48" height="48"/></li>
        <li> <RouterLink :to="{ name: 'HomePage' }">{{$t('menu.home')}}</RouterLink></li>
        <li> <RouterLink :to="{ name: 'AboutPage' }">{{$t('menu.about')}}</RouterLink></li>
        <li><RouterLink :to="{ name: 'ContactPage' }">{{$t('menu.contact')}}</RouterLink></li>
